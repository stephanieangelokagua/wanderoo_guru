...
function possibleDestinations() {
    ...
    if (filterDestinationsByBudget.length === 0) {
        cardContainer.innerHTML = '<p style="color: red; font-size: 1.5em; text-align: center; background-color: transparent;">We are sorry, there are no destinations available for your budget!</p>'
        return;
